...
| [0004](0004-rendercv-for-cv.md) | Generate the CV from RenderCV YAML (`engineeringresumes` theme, Typst) instead of hand-written HTML (supersedes task 0009's approach) | accepted | 2026-08-14 |
